function varargout = maxivU_c2_1_1(varargin)
%
...
QFI     = atsbend('QFI', 0.150000, -2*q3*pi/180, 5.368969560153515, 'BndMPoleSymplectic4Pass');
...
D0_U3  = atsbend('DIP', 0.361890, 1.094181* (1+4*q3/sU) *pi/180, -0.864858/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF1_U3 = atsbend('DIP', 0.050000, 0.151199* (1+4*q3/sU) *pi/180, -0.864908/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF2_U3 = atsbend('DIP', 0.050000, 0.151101* (1+4*q3/sU) *pi/180, -0.866059/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF3_U3 = atsbend('DIP', 0.050000, 0.101861* (1+4*q3/sU) *pi/180, -0.551829/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF4_U3 = atsbend('DIP', 0.050000, 0.001569* (1+4*q3/sU) *pi/180,  0.011759/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF5_U3 = atsbend('DIP', 0.050000, 0.000089* (1+4*q3/sU) *pi/180, -0.000128/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');

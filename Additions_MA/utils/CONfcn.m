...
% % %     qfendi = findcells(rrr,'FambxiName','QFEND');
...
C(9)   = -1; %abs(dphix2 - 3/7)/(3/7)-0.4; % dphix wrt 3/7 less than 30% 
C(10)  = -1; %abs(dphiy1 - 1/7)/(1/7)-0.4; % dphix wrt 3/7 less than 30% 
C(11)  = -1; %abs(dphiy2 - 1/7)/(1/7)-0.4; % dphix wrt 3/7 less than 30% 
C(12)  = -1; %(abs(Rnu) - 3)/3 - 0.6; %0.4 

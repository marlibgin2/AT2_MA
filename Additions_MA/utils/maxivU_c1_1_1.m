function varargout = maxivU_c1_1_1(varargin)
%
% lattice correpsonding to the best so far 'C' case with
% NO anti-bends
% stems from maxivU_a1_1_1 where I pregressivly introduce an anti-bend
% angle
%
...
QFI     = atsbend('QFI', 0.150000, -thU3/2, 5.368969560153515, 'BndMPoleSymplectic4Pass');
QFO     = atmultipole('QFO'   , 0.150000, [0 0 0 0], [0  5.363362946624617 0 0], 'StrMPoleSymplectic4Pass','MaxOrder',2);
%QFO     = atsbend('QFO', 0.150000, -thU2*1.5, 5.363362946624617, 'BndMPoleSymplectic4Pass');
...
D0_U1  = atsbend('DIP', 0.361890, 1.094181*pi/180, -0.864858/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF1_U1 = atsbend('DIP', 0.050000, 0.151199*pi/180, -0.864908/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF2_U1 = atsbend('DIP', 0.050000, 0.151101*pi/180, -0.866059/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF3_U1 = atsbend('DIP', 0.050000, 0.101861*pi/180, -0.551829/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF4_U1 = atsbend('DIP', 0.050000, 0.001569*pi/180,  0.011759/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF5_U1 = atsbend('DIP', 0.050000, 0.000089*pi/180, -0.000128/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');

D0_U2  = atsbend('DIP', 0.361890, 1.094181*pi/180 + thU2 * 1.094181/sU, -0.864858/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF1_U2 = atsbend('DIP', 0.050000, 0.151199*pi/180 + thU2 * 0.151199/sU, -0.864908/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF2_U2 = atsbend('DIP', 0.050000, 0.151101*pi/180 + thU2 * 0.151101/sU, -0.866059/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF3_U2 = atsbend('DIP', 0.050000, 0.101861*pi/180 + thU2 * 0.101861/sU, -0.551829/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF4_U2 = atsbend('DIP', 0.050000, 0.001569*pi/180 + thU2 * 0.001569/sU,  0.011759/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF5_U2 = atsbend('DIP', 0.050000, 0.000089*pi/180 + thU2 * 0.000089/sU, -0.000128/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');

D0_U3  = atsbend('DIP', 0.361890, 1.094181*pi/180 + thU3 * 1.094181/sU, -0.864858/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF1_U3 = atsbend('DIP', 0.050000, 0.151199*pi/180 + thU3 * 0.151199/sU, -0.864908/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF2_U3 = atsbend('DIP', 0.050000, 0.151101*pi/180 + thU3 * 0.151101/sU, -0.866059/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF3_U3 = atsbend('DIP', 0.050000, 0.101861*pi/180 + thU3 * 0.101861/sU, -0.551829/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF4_U3 = atsbend('DIP', 0.050000, 0.001569*pi/180 + thU3 * 0.001569/sU,  0.011759/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
DF5_U3 = atsbend('DIP', 0.050000, 0.000089*pi/180 + thU3 * 0.000089/sU, -0.000128/-0.864858 * -1.047900393461509, 'BndMPoleSymplectic4Pass');
...
DIPUC1 = cellcat(SD, str0010, DIP1, flip(DIP1), str0010, SD);
DIPUC2 = cellcat(SD, str0010, DIP2, flip(DIP2), str0010, SD);
DIPUC3 = cellcat(SD, str0010, DIP3, flip(DIP3), str0010, SD);
DIPUC4 = cellcat(SD, str0010, DIP2, flip(DIP2), str0010, SD);
DIPUC5 = cellcat(SD, str0010, DIP1, flip(DIP1), str0010, SD);
...
UC4     = cellcat( strx403, DIPUC2, strx203, flip(SQFO));
UC5     = cellcat( strx403, DIPUC2, strx203, flip(SQFM));

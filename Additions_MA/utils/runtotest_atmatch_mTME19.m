...
Dlgbh=struct('Fun',@(RING,~,~)dispx2(RING,lgbhindx(1)),...
    'Min',0.0110,...
    'Max',0.0114,...
    'RefPoints',[1],...
    'Weight',1);
...
MB22=struct('Fun',@(RING,~,~)max(bety(RING,1:166)),...
    ...
    'RefPoints',[],...
    'Weight',1);
MD22=struct('Fun',@(RING,~,~)max(dispx(RING,1:166)),...
    'Min',0.0356,...
    'Max',0.0356,...
    'RefPoints',[],...
    'Weight',1);
mD22=struct('Fun',@(RING,~,~)min(dispx(RING,1:166)),...
    'Min',0.0356,...
    'Max',0.0356,...
    'RefPoints',[],...
    'Weight',1);
...
Constr = [ B110 B210 Ds1h4 DP110 B111 Ds1h6 DP111 ...
           B112 D112 DP112 A12 A21 D30 DP200 DD200 ...
           DP201 MB22 Bxy30]; %  C41 C42 C51 C52 C61 C62];
...
RING_matched_optconstr=atmatch(RING,Variab,Constr,10^-8,1000,3,@lsqnonlin);%

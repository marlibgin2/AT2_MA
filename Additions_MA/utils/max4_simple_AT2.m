...
uc1     = cellcat( GirderStart, sqfm, str0100, corr, strx203, sd, str0010, Dip, str0010, sd, GirderEnd, strx403 );
uc2     = cellcat( GirderStart, sqfo, str0100, corr, strx203, sd, str0010, Dip, str0010, sd, GirderEnd, strx403 );
uc3     = cellcat( GirderStart, sqfi, str0100, corr, strx203, sd, str0010, DipUC3, str0010, sd, ...
    strx203, corr, str0100, sqfi(end:-1:1), GirderEnd );
uc4     = cellcat( strx403, GirderStart, sd, str0010, Dip(end:-1:1), str0010, sd, strx203, corr, str0100, sqfo(end:-1:1), GirderEnd );
uc5     = cellcat( strx403, GirderStart, sd, str0010, Dip(end:-1:1), str0010, sd, strx203, corr, str0100, sqfm(end:-1:1), GirderEnd );


mc1a1   = cellcat( GirderStart, hvpu, str0010, str0048, corr, str0021, oxxo, str0025, qfend, str0025, oxyo, str0100, ...
            qdend, strx006, dipm, oyyo, strx093, corrs, hvpu, str0020, sdend, GirderEnd );           % Missing AC corrector due to injection channel
mc2a1   = cellcat( GirderEnd, hvpu, str0010, str0048, corr, str0021, oxxo, str0025, qfend, str0025, oxyo, str0100, ...
            qdend, strx006, dipm, oyyo, strx093, corr, hvpu, str0020, sdend, GirderStart );            % Missing AC corrector due to injection channel


mc1     = cellcat( GirderStart, hvpu, str0010, corr_ac, str0048, corr, str0021, oxxo, str0025, qfend, str0025, oxyo, str0100, ...
            qdend, strx006, dipm, oyyo, strx093, corrs, hvpu, str0020, sdend, GirderEnd );
mc2     = cellcat( GirderEnd, hvpu, str0010, corr_ac, str0048, corr, str0021, oxxo, str0025, qfend, str0025, oxyo, str0100, ...
            qdend, strx006, dipm, oyyo, strx093, corr, hvpu, str0020, sdend, GirderStart );

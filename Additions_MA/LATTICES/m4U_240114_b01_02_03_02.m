function varargout = m4U_240114_b01_02_03_02__grd_segmented(varargin)
...
kQ1  =  4.094329072443061; %  4.126576123705094;
kQ2  = -2.786287957864051; % -2.697078963828588;
kQ3  =  4.096209208133678; %  4.210435344175177;
kQ4  =  4.350938638910979; %  4.210435344175177;
kQ5  =  5.094154753265104; % 5.469383459895300;
kQ6  =  5.966445520154291; % 5.469383459895300;
kR1  =  4.506762240334659; % 5.387917968472925;
kR2  =  6.266897464191882; % 5.387917968472925;
...
% SEXTs
% -----
k2S1 = -1.654986782091373e+02;
k2S2 =  2.934700000000000e+02;
k2S3 = -2.324930372170136e+02;
k2S4 =  2.695493861890224e+02;
k2S5 =  2.276491262143600e+02;
...
% OCTs
% ----
O1  = atmultipole('O1' , 0.10000, [0 0 0 0], [0 0 0 -1.959143631771644e3], 'StrMPoleSymplectic4Pass','MaxOrder',3,'EApertures',[Rx, Ry]);  
O2  = atmultipole('O2' , 0.10000, [0 0 0 0], [0 0 0  1.775925957683045e3], 'StrMPoleSymplectic4Pass','MaxOrder',3,'EApertures',[Rx, Ry]); 
O3  = atmultipole('O3' , 0.10000, [0 0 0 0], [0 0 0  0.523382601797927e3], 'StrMPoleSymplectic4Pass','MaxOrder',3,'EApertures',[Rx, Ry]); 
...
CMh     = atcorrector('CMh',0.0,[ 0 0 ],'CorrectorPass');
CMv     = atcorrector('CMv',0.0,[ 0 0 ],'CorrectorPass');

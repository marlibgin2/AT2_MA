...
ACHRO = ACHRO_Ake0; % The cell array with the AT2 lattice to be evaluated
...
cLoptions.ringtune_fams = {};   % magnet families for tune matching
cLoptions.chrom_fams    = {}; % magnet families for chromaticity matching
cLoptions.eqfam = {};
cLoptions.eqsca = {} ;

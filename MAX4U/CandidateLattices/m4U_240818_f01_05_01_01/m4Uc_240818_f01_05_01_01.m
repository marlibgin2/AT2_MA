...
lattname = 'm4U-240818-f01-05-01-01';
desc = 'derived rom m4U-240807-f01-03-01, readjusted dipm field profile, deterministic match';
%m4U('f1');

%DR=DetAchrMatch(LatticeOptData,'fixrbk','verbose',2,'fitdisp','fitalphas',...
%    'dx',10,'nitAlpha',100,'nojoint','fitchro',...
%    'tunes',[44.218 13.385]);
DR=DetAchrMatch(LatticeOptData,'fixrbk','verbose',1,'fitdisp','fitalphas','nitAlpha',100,'nitdisp',200,'dx',10,'optfunct','newtonraphson','plot','nojoint');

%DR=DetAchrMatch(LatticeOptData,'fixrbk','verbose',1,'fitdisp',...
%   'fitalphas','nitAlpha',100,'nojoint','nitdisp',200,'dx',10,'optfunct','newtonraphson',...
%   'plot','tunes',[44.28, 18.20]);
%DR=DetAchrMatch(LatticeOptData,'fixrbk','verbose',2,'plot','nitAlpha',100,'nojoint','nitdisp',200);
ACHRO = DR.outputs.ACHROMATGRD;

% ACHRO = ACHROGRD_f1; % The cell array with the AT2 lattice to be evaluated

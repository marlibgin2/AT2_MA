...
lattname = 'm4U-jb7';
desc = 'From Johan 20240731';

ACHRO = max_4u_sp_jb_7(); % The cell array with the AT2 lattice to be evaluated
...
cLoptions.chrom_fams    = {'s3';'s4'}; % magnet families for chromaticity matching
cLoptions.sext_fams     = {'s1';'s2';'s3';'s4'}; % list of all sextupole families plot

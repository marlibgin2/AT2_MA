     ...
     if (corrorbf) 
         try
            ...
            for j=1:6
             ...
             fprintf('%s calcLMAdist: Error in orbit correction for seed n. %4d \n', datetime, i-1);
     ...
     if (corrtunf)
         try
           ...
           if (not(isnan(Itunese{i}(1)))&&not(isnan(Itunese{i}(2))))
              if (verboselevel>1)
                 fprintf('%s calcLMAdist: Fitting tunes from [ %5.3f %5.3f ] to [ %5.3f %5.3f ] for seed n. %3d \n',...
              ...
              [RINGe{i}, its, penalty_tune, Ftunese{i}] = ...
                ...
                if (verboselevel>1)
                 ...
                 fprintf('%s calcLMAdist: Unstable Lattice Tunes = [ %5.3f %5.3f ]  for seed n. %4d \n',...
                    datetime, Itunese{i}(1), Itunese{i}(2), i-1);
           end
         catch ME
             fprintf('%s calcLMAdist: Error in tune correction for seed n. %4d\n', datetime, i-1);
             fprintf('Error message is %s \n', ME.message);
             stablat(i)=0;
         end
     else

...
if (isempty(fields(LMAdist)))
    ...
    if (fulloutputf)
        LMAdist = calcLMAdist(RING,ErrorModel,MAoptions,'ERlat',ERlat,...
                      'corrorb',corrorbf,'corrtun',corrtunf,...
                      'S0max',S0max,'S0min',S0min,...
                      'deltalimit',deltalimit,'tunfams',tunfams,...
                      'nseeds',nseeds,'verbose', verboselevel-1, ...
                      'useORM0',useORM0f,'fulloutput');
    else
        LMAdist = calcLMAdist(RING,ErrorModel,MAoptions,'ERlat',ERlat,...
                      'corrorb',corrorbf,'corrtun',corrtunf,'S0max',...
                       S0max,'S0min',S0min,...
                      'deltalimit',deltalimit,'tunfams',tunfams,...
                      'nseeds',nseeds,'useORM0',useORM0f,...
    ...
    if(nseeds~=LMAdist.inputs.nseeds)
        ...
        fprintf('%s CalcTLTdist Warning: nseeds changed to %3d \n', datetime, nseeds);
    end
end

...
if ( (c(1)<0)&&(c(2)<0) )
    [RD,TD] = atlinopt4(UC,1:length(UC)+1,'coupled',false);
    [~,I2d,~,I4d,~,~,~] = DipoleRadiation_fast(UC,TD,isdipole);
    Jx    = 1 - I4d/I2d;
    c(11) = Jx-3.0;

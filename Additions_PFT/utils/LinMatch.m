...
%% Inputs
% Mandatory inputs
% LatticeOptData : structure generated by m4U.m containing optimizaiton
%                  options
% ACHRO: AT2 lattice cell array - one achromat (no girder markers)
%
% Optional inputs
%  fitdisp : if present fits dispersion
%  tunes: target tunes for 20 achromats
%
%  dx: percent range around initial magnet strength values in which fits are searched
%
%% Usage example
%% History
% PFT 2023 first version
% PFT 2024/08/13 : updates to deal with lattice type f1 and longitudinal

...
%
% dpmin : minimum energy deviation for xdp and ydp plots
% dpmax : maximum energy deviation for xdp and ydp plots
% 
% Optional flags
...
dpmin    = getoption(varargin,'dpmin',DAS.inputs.dpmin);
dpmax    = getoption(varargin,'dpmin',DAS.inputs.dpmax);
...
switch DAS.inputs.mode
    ...
    case {'xydp';'XYDP'}
        ...
        figure;plot(dps*100,DAXp*1000);hold;plot(dps*100,DAXm*1000);
        xlabel('dp[%]');ylabel('X[mm]');

        figure;plot(dps*100,DAYp*1000);
